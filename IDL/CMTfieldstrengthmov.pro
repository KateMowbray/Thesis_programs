...
;;   endif
  ...
  ;; stuff for poster, get rid of all of this

;  IF (number eq 0) then begin
;    posterplot=plot(ll, bb, xr=[0,7],yr=[0.08,0.4], xtit='arc length',ytit='field strength',COLOR='r')
;      FOR ip=0,nparticles-1 DO BEGIN
;       xdata=particles(ip,number,0)
;       ydata=particles(ip,number,1)
;       zdata=particles(ip,number,2)
...
;       posterplot=scatterplot([xpoint,xpoint],[ypoint,ypoint],SYMBOL='star',SYM_COLOR='r',OVERPLOT=1)
;       endif
;       if (ip eq 1) then begin
;       posterplot=scatterplot([xpoint,xpoint],[ypoint,ypoint],SYMBOL='square',SYM_COLOR='r',OVERPLOT=1)
;       endif
;       if (ip eq 2) then begin
;       posterplot=scatterplot([xpoint,xpoint],[ypoint,ypoint],SYMBOL='circle',SYM_COLOR='r',OVERPLOT=1)
;       endif
;      endfor
;  endif

;  IF (number eq 8) then begin
;    posterplot=plot(ll, bb,COLOR='m', overplot=1)
;      FOR ip=0,nparticles-1 DO BEGIN
;       xdata=particles(ip,number,0)
;       ydata=particles(ip,number,1)
;       zdata=particles(ip,number,2)
...
;       print, xpoint, ypoint
;       if (ip eq 0) then begin
;       posterplot=scatterplot([xpoint,xpoint],[ypoint,ypoint],SYMBOL='star',SYM_COLOR='m',OVERPLOT=1)
;       endif
;       if (ip eq 1) then begin
;       posterplot=scatterplot([xpoint,xpoint],[ypoint,ypoint],SYMBOL='square',SYM_COLOR='m',OVERPLOT=1)
;       endif
;       if (ip eq 2) then begin
;       posterplot=scatterplot([xpoint,xpoint],[ypoint,ypoint],SYMBOL='circle',SYM_COLOR='m',OVERPLOT=1)
;       endif
;      endfor
;  endif

;  IF (number eq 20) then begin
;    posterplot=plot(ll, bb,COLOR='g', overplot=1)
;      FOR ip=0,nparticles-1 DO BEGIN
;       xdata=particles(ip,number,0)
;       ydata=particles(ip,number,1)
;       zdata=particles(ip,number,2)
...
;       print, xpoint, ypoint
;       if (ip eq 0) then begin
;       posterplot=scatterplot([xpoint,xpoint],[ypoint,ypoint],SYMBOL='star',SYM_COLOR='g',OVERPLOT=1)
;       endif
;       if (ip eq 1) then begin
;       posterplot=scatterplot([xpoint,xpoint],[ypoint,ypoint],SYMBOL='square',SYM_COLOR='g',OVERPLOT=1)
;       endif
;       if (ip eq 2) then begin
;       posterplot=scatterplot([xpoint,xpoint],[ypoint,ypoint],SYMBOL='circle',SYM_COLOR='g',OVERPLOT=1)
;       endif
;      endfor
;  endif

;  IF (number eq 60) then begin
;    posterplot=plot(ll, bb,COLOR='b', overplot=1)
;      FOR ip=0,nparticles-1 DO BEGIN
;       xdata=particles(ip,number,0)
;       ydata=particles(ip,number,1)
;       zdata=particles(ip,number,2)
...
;       print, xpoint, ypoint
;       if (ip eq 0) then begin
;       posterplot=scatterplot([xpoint,xpoint],[ypoint,ypoint],SYMBOL='star',SYM_COLOR='b',OVERPLOT=1)
;       endif
;       if (ip eq 1) then begin
;       posterplot=scatterplot([xpoint,xpoint],[ypoint,ypoint],SYMBOL='square',SYM_COLOR='b',OVERPLOT=1)
;       endif
;       if (ip eq 2) then begin
;       posterplot=scatterplot([xpoint,xpoint],[ypoint,ypoint],SYMBOL='circle',SYM_COLOR='b',OVERPLOT=1)
;       endif
;      endfor
;  endif

;; poster stuff ends here
