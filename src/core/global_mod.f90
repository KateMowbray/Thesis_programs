...
! km: Very little changed here, just added functionality for CMT2 which is set up for 2D and 2.5D fields
...
!########################################################################## 
 CHARACTER(Len = 4), PARAMETER	:: FMOD='CMT' ! SWITCH BETWEEN FIELDS: "l3d","l2d", "SEP","CMT", "CMT2", "test","bor", "NLFF", "MHDp"
...
! NORMALISING SCALES 
 REAL(num), PARAMETER	:: Lscl = 1e7_num     		! 10 Mega meters (1e7)
...
! (required by CMT module)
 ...
 REAL(num), PARAMETER	:: Bzfinal =0.00!005    !0.1426754410 
 REAL(num), PARAMETER	:: esp=1.0  ! esponent in log transformation
 REAL(num), PARAMETER	:: cc=0.4!(0.4/SQRT(1.05))**(2.0/3.0)!SQRT(0.4/1.05)  ! coeff in log transformation
